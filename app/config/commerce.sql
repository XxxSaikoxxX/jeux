...
drop database if Exists projet432;
-- creation de ma base donnee
create database projet432;
use projet432;
...
-- l'utilisateur Tom a comme mot de passe Tom1234
INSERT INTO Utilisateur(nom,prenom,email,mot_de_passe,date_de_creation)
            values ("Tom","Jerry","tom@jerry.ca","$2y$10$pmTgU.CA3J8ppEvvKs7IkOxCCtCGBeNyf1Scvoy.TCmjQpZzzHfjK","2023-07-07 13:25:00");
